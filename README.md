...
6. t2.bed = output of module 2 (BED6 format)
...
3. t2.bed = output from Bimodal CNN (BED6 format)
4. t2_rpm.txt = Final result (ID, Start, End, Strand, Sequence, Secondary Struture)
